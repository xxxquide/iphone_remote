...
# Heal a .env generated by the older example that had inline comments
if [ -f .env ] && grep -qE '^[A-Z_]+=.*[[:space:]]#' .env; then
  warn "your .env has inline comments (older format) — backing up and regenerating"
